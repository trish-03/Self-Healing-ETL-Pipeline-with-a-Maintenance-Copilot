...
export default function OCCConflictTable({
  ...
  return (
    <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden">
      {/* Header Controls */}
      <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="bg-slate-50 dark:bg-[#0b0f17] border border-slate-200 dark:border-slate-700 rounded-md text-xs px-2.5 py-1.5 text-slate-900 dark:text-slate-100 focus:outline-none focus:border-rose-500 transition"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-md text-slate-400 dark:text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition"
